...
function renderWeather(city) {
    ...
    fetch(`http://api.openweathermap.org/data/2.5/forecast?q=${city}&appid=d99c9c87a4de1715a33c5209fa0f3fdd&units=imperial`)// promise based
